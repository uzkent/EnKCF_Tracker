...
interest on deployment of computer vision technologies on mobile
platforms. For example, an unmanned air vehicle (UAV) equipped with
object tracking would make it more useful in the application of
...
that could run on any embedded systems with small form factors.
