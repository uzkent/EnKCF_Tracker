...
ours are precision on 20 pixels, 72.53\%, AUC 52.90\% for OTB100 data
and 55.71\% and 41.71\% for UAV123 data. This confirmed that our tracker outperformed the existing high speed correlation filter based trackers about $5\%$ in terms of precision and $15\%$-$20\%$ in AUC. Finally,  our implementation ran at 340 fps for OTB100 dataset and at 416 fps for UAV123 dataset that is as fast as other correlation filter based trackers such as KCF ($292$ fps), DCF($457$ fps) and STC ($300$ fps) for UAV123.
\end{abstract}
