...
we compared the performance of ours to those of existing online
...
and $55.71\%$ and $41.71\%$ for UAV123 data. This confirmed that our tracker outperformed the existing high speed correlation filter based trackers about $5\%$ in terms of precision and $10\%$-$20\%$ in AUC. Finally,  our implementation ran at $340$ fps for OTB100 dataset and at $416$ fps for UAV123 dataset that is as fast as other correlation filter based trackers such as KCF ($292$ fps), DCF($457$ fps) and STC ($350$ fps) for UAV123.
\end{abstract}
