...
ours are precision on 20 pixels, 69.53\%, AUC 52.90\% for OTB100 data
and 54.11\% and 40.21\% for UAV123 data. This confirmed that our
method outperformed the existing ones over 5\% on precision on 20
pixels and 3\% on AUC on average. Our implementation ran at 340 fps
for OTB100 and at 416 fps for UAV123 data that is faster than DCF (292
fps) for OTB100.
\end{abstract}
