...
{\it YoungWoo : I placed EnKCF with traditional and deep features
  section right after EnKCF section. Later, you placed them after the
  Kernelized Correlation Filter section. To me, it makes more sense to
  place them right after the EnKCF section.}

{\it Burak: I don't think that's a good way of arranging this. You
  talked about EnKCF, then KCF should come out before any variants of
  KCF w/ conventional feature and w/ deep features. Otherwise, what is
  the point of having KCF section after you explained all the usage of
  KCF? So, it should EnKCF, KCF, KCF w/ hand-craft features and KCF w/
  deep features. Given this order, two paragraphs before and after
  this didn't connect!}
...
correlation filter on a single ROI. 
...
By reducing the template size of $R_{s}$,
