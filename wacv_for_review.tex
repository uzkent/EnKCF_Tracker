...
%\begin{comment}
\textit{YoungWoo : I added the following equations about the update scheme of the KCF.}
...
\ref{fig:UAV123_DATASET} shows the results on the UAV123 dataset. The
    ...
    features. \textit{YoungWoo : is this sentence not confusing? Maybe, Learning 
    more features provided a better understanding of the ROI?} 
    Learning more features, not always, but provided a
...
study \textit{YoungWoo : should it not be under which conditions?} 
when and what conditions our algorithm would fail to track
