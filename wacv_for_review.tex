...
\begin{comment}
In practice, the solution vector, $\mathbf{\hat{\alpha}}$, and 
the feature template matrix, $\mathbf{x}$, are accumulated over time
to integrate temporal information as
\begin{align}
...
where $\beta$ is the learning rate and mostly tuned to a small value.
\end{comment}
