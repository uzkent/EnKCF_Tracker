...
displacements of the moving objects become even bigger. To tackle this challenge, we 
slightly modified the proposed algorithm -- ran $R_{t}^{L}$ every frame and
removed the particle filter due to larger ego-motion. Figure \ref{fig:UAV123_10fpsDATASET}
...
\textit{YoungWoo : I also believe that we should emphasize how the state-of-the-art
trackers perform in lower frame rates. And I believe this is what this paper \cite{mueller2017context}
says. They rank the trackers by evaluating them on videos matching their fps. I was thinking of running 
ECO and CCOT in UAV123 in 5 fps videos and mention how they degrade with respect to the decreasing fps.
I believe this is our contribution and we should emphasize it.}
