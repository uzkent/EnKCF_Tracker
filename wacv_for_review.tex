...
correlation filter over consecutive frames would not be much different
...
\textbf{Finding Optimal Hyper-parameters} As each of three KCFs in
       ...
       \approx (\sum_{p=1}^{P}w_{p}^{2})^{-1} $), is lower than a
...
\cite{bolme2010visual,henriques2015high}, and STC \cite{zhang2014fast}
and ones in relatively lower-speed ($\geq$50): SAMF
...
KCFs. Two public datasets were used to evaluate the performance of the
