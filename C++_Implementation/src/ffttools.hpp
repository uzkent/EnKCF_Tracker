...
cv::Mat fftd_w_roi(cv::Mat img, bool backwards = false);
cv::Mat fftd_scale(cv::Mat img, bool backwards = false);
...
cv::Mat fftd_w_roi(cv::Mat img, bool backwards)
{
/*
#ifdef USE_FFTW
...
cv::Mat fftd_scale(cv::Mat img, bool backwards)
{
/*
#ifdef USE_FFTW
