...
\end{equation}
To make the above, closed-form solution more robust to any geometric
and photometric variations, a non-linear version is also proposed
\cite{henriques2015high}.
%\begin{equation}
