...
computational efficiency is derived from the fact that the correlation
filter framework represents training examples as the circulant matrix
and the circulant matrix can be represented as a diagonal matrix by
...
down-sampled version of the UAV123 dataset, we call
``UAV123$\_$10fps'' dataset.
