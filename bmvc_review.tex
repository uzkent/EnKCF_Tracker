...
integrate multi-channel features such as HoG and color into the ridge
...
MOSSE tracker uses one training sample centered at estimated position
...
shifted patches of the positive training sample $x$ by a cyclic shift
operator.
