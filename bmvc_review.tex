...
\caption{Some results of the proposed high-speed ($\geq300$fps) {\it E}nKCF tracker on UAV123 dataset where scale change between the frame in the top row and bottom row is large or small($\leq0.5$, or $\geq2$).}
...
results of KCF \cite{henriques2015high} on VOT15\footnote{\url{http://www.votchallenge.net/vot2015/}} challenge, many variation of KCF were
