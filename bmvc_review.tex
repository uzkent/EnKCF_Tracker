...
(b)
\end{tabular}
\caption{The workflow of the proposed $\geq300$fps {\it E}nKCF tracker
  (a). It is slightly modified to handle extreme ego-motion and we
  call it the {\it E}nKCF2 tracker (b) running at $\geq100$fps.}
\label{Workflows}
\end{figure}
