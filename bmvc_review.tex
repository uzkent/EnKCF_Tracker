...
\hline
Metric/Method & $R_{t}^{L}$+$R_{t}^{S}$+$R_{s}$ ({\it E}nKCF) & $R_{t}^{L}$+$R_{s}$ & $R_{t}^{S}$+$R_{s}$ & $R_{t}^{L}$ & $R_{t}^{S}$ & LCT \cite{ma2015long}\\
\hline\hline
Precision ($20$px) & \textbf{54.5} & 48.09 & 52.50 & 51.88 & 51.29 &\\
Success Rate ($50\%$) & \textbf{40.2} & 36.04 & 37.85 & 35.12 & 34.42 & \\
Frame Per Second & \textbf{416} & 370 & 343 & 367 & 490 & \\
\hline
\end{tabular}
\end{center}
\caption{Evaluations of the different combinations of the proposed KCFs in UAV123 dataset. We decouple the re-detection module of the LCT tracker as we focus on the comparison of the multiple correlation filter framework between LCT and  {\it E}nKCF.}
\end{table}
