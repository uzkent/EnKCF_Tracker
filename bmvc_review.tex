...
\bmvaHangBox{\includegraphics[width=3.20cm]{./figures/Success_UAV123.eps}}
\bmvaHangBox{\includegraphics[width=2.80cm]{./figures/Precision_OTB100.eps}}
\bmvaHangBox{\includegraphics[width=3.20cm]{./figures/Success_OTB100.eps}}\\
\end{tabular}
\caption{Comparison of {\it E}nKCF's performance with those of the
  state-of-the-art tracking algorithms on the UAV123 and OTB100 datasets.}
