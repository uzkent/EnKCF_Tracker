...
when it is deployed on a low-end, embedded system.\footnote{We
  empirically found this computation useful and reasonable -- the
...
a target's translation. And then they attemped to update the scale of
...
right size or scale of the target. Figkure \ref{fig:Filters} shows
